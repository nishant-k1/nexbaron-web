...
export const metadata: Metadata = {
  title: {
    default: 'Nexbaron Services Private Limited | Leading Infrastructure Solutions',
    template: '%s | Nexbaron Services',
  },
  description: 'Nexbaron Services Private Limited delivers world-class infrastructure solutions across multiple industries. Trusted partner for engineering excellence and compliance.',
  keywords: ['infrastructure', 'engineering', 'compliance', 'construction', 'Nexbaron'],
