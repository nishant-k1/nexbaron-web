      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-5 mb-10">
          <div>
            ...
            <p className="text-sm text-slate-200 mt-3">Track requests and confirmed pricing.</p>
          </div>
          <Button
            asChild
        ...
        {!initialized || loading ? (
          <div role="status" className="flex justify-center py-20 text-slate-200">
              ...
              >
                ...
                {quote.response?.price && (
                  <div className="mt-5 pt-4 border-t border-white/10 flex justify-between items-center">
                    <span className="text-sm text-slate-200">Confirmed price</span>
                ...
                {quote.response?.message && (
                  <p className="mt-4 text-sm text-slate-200">{quote.response.message}</p>
                )}
              </article>
            ))}
          </div>
