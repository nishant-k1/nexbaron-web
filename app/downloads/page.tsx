...
export const metadata: Metadata = {
  title: 'Downloads',
  description: 'Download company brochures, compliance documents, and tender-related materials from Nexbaron Services.',
  openGraph: {
...
const downloadCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Technical Specifications Template', size: '2.1 MB', format: 'PDF' },
    ],
  },
]
                ...
                <div key={category.title} className="bg-white p-6 rounded-lg shadow-surface">
                  ...
                  <ul className="space-y-4">
                    {category.items.map((item) => (
                      <li
                        key={item.name}
                        className="flex items-center justify-between p-4 border border-muted rounded-base hover:bg-surface transition-colors"
                      >
