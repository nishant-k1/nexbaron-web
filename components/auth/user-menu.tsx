      ...
      {open && (
        ...
        >
          <div className="px-3 py-2.5 border-b border-white/10 mb-1">
            ...
            <div className="text-xs text-slate-200 truncate">{user.email ?? user.phone}</div>
          </div>
          <button
            role="menuitem"
            onClick={() => {
          ...
          <button
            ...
            className="w-full flex items-center gap-2 px-3 py-2 rounded-xl text-sm text-slate-200 hover:bg-white/5"
          >
