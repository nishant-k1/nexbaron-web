        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              ...
              className="hidden lg:inline-flex text-[11px] font-mono text-slate-400 hover:text-amber-400 transition-colors ml-3"
            >
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="px-6 pb-8 pt-4 border-t border-white/10 space-y-3">
              ...
              <Link
                href={divisions.digital.otherDivision.href}
                className="block text-center text-xs font-mono text-slate-400 hover:text-amber-400 transition-colors pt-2"
              >
                {divisions.digital.otherDivision.label}
              </Link>
            </div>
